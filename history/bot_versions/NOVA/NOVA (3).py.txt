...
DEFAULT_SCALP_SYMBOLS = "BTCUSDT,ETHUSDT,BNBUSDT,SOLUSDT,LINKUSDT,RENDERUSDT,TONUSDT,FILUSDT,ATOMUSDT,VETUSDT,XLMUSDT"
SYMBOLS = []
...
def run_scan(force=False):
    ...
    try:
        ...
        if any(value is None for value in leader_frames.values()):
            ...
            if report:
                send_message("⚠️ فشل تحميل بيانات BTC/ETH/BNB؛ سأعيد المحاولة تلقائياً.")
            return None
