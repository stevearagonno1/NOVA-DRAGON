#!/bin/bash
# ═══ NOVA v5 ZERO-WAIT QUANT — مشغّل سكالبينج (نسخة آمنة، بلا أسرار في الكود) ═══
...
python3 -m nova_bot.main --selftest || { echo "❌ الاختبار فشل — لن يعمل البوت"; exit 1; }

# 3) إقلاع NOVA v5
echo "🚀 إقلاع NOVA v5 ZERO-WAIT QUANT (Testnet)..."
python3 -m nova_bot.main
