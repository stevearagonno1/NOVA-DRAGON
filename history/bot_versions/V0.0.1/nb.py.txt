...
المصدر: KB §4.11 (Viprasol) — جزء أساسي من المحرك، لا خيار.
  - ميزات لكل بار (O(1)): delta حقيقي (aggTrade), CVD, cvdRoc, priceRoc, slopeR.
    ثم F1/F2/F3 = z-score متحرك (نافذة z_window) عبر مخازن منزلقة.
...
# ── Testnet entry threshold ───────────────────────────────
# Minimum acceptable Bull posterior for opening a long on Testnet (55%).
NB_MIN_ENTRY_PROB = 0.55
