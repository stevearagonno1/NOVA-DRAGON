...
MATRIX_CACHE_VER = 4                                   # bump on logic change
...
# ------------------------------------------------------------ timeframes
TF_TRADE = os.getenv("NOVA_TF_TRADE", "1m")   # execution timeframe (1m today)
...
# fib_act, fib_p1, fib_p2, fib_p2_trigger, time_bars, time_min_profit.
