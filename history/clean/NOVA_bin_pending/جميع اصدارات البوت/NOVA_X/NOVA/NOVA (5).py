...
# -*- coding: utf-8 -*-
"""
NOVA ASYNC SCALPER V5.0 — Weighted-Scoring Microstructure Engine (Risk-Parity)
==============================================================================
...
STARTUP_TEXT = "✅ NOVA Async V5 Started & Connected to Binance WebSockets."
...
HELP_TEXT = (
    "🤖 <b>NOVA ASYNC SCALPER V5.0 — Weighted Scoring + Risk Parity</b>\n\n"
...
async def handle_command(text, chat):
    ...
    if command in ("/start", "/menu"):
        await send_message("🎛️ <b>NOVA ASYNC SCALPER V5.0</b>\nاختر عملية:", main_keyboard(), chat)
    elif command == "/help":
        await send_message(HELP_TEXT, main_keyboard(), chat)
    elif command == "/status":
        await send_message(status_text(), main_keyboard(), chat)
