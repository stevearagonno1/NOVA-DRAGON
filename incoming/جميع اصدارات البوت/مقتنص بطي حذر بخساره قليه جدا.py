...
BREAKEVEN_TRIGGER_PCT = env_float("BREAKEVEN_TRIGGER_PCT", 0.25)  # ربح يفعّل التعادل والتتبّع
...
TIME_STOP_SEC = max(60, env_int("TIME_STOP_SEC", 1800))      # 15 دقيقة سكالب: مات الزخم → اخرج
