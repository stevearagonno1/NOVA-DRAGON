...
## المحفظة الموحدة L0014 (2026-09-19) — 13 عملة على 4h: حافة رابحة والفيصل الكلفة

- النطاق: توحيد سلة L0010 الستة وسلة L0013 السبعة من سلاسل صفقاتهما المودعة — صفر إعادة تشغيل وصفر اختيار
- الأساس: 9,677 صفقة · ‏+70,685.63‏$ · PF 2.58 · هبوط 1,224.92$ في 10 أيام · أسوأ يوم ‏−929.47‏$ · احتفاظ 6.37 ساعة · DSR z=21.25
- العمياء: 10 عملات قابلة · ‏+81,708.03‏$ · PF 3.19 (GRAM وRENDER وTON بلا بيانات قبل 2024)
- الكلفة القاسية 0.30%: ‏+9,746.73‏$ لكن PF 1.14 · هبوط 3,644.47$ في 112 يومًا · ربعان سالبان · DSR 0.745 ⇒ هشّة
- الجوار 117/117 · الترابط اليومي متوسط 0.295 والاستثناء GRAM–TON 0.959
- ضد الاحتفاظ: ‏−9,340.31‏$ مقابل ‏+70,685.63‏$ للبوت (فرق ‏+80,025.94‏$)
- الحكم المقترح: نطوّر — الفيصل كلفة التنفيذ الحية (مسبار ورقي بإذن صريح) وضبط حجم المركز
- الأدلة: `docs/lanes/L0014-unified-portfolio-13.md` + `history/research/hyp_lab_out/L0014/`
